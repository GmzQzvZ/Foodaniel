window.FoodanieleeI18n = (function () {
  ...
  const texts = {
    es: {
      ...
      register_open_privacy: 'Abrir Política de Privacidad',
      register_accept_privacy_prefix: 'He leído y acepto la ',
      register_privacy_policy: 'Política de Privacidad',
      register_privacy_status: '⚠️ Debes abrir la Política de Privacidad para poder registrarte.',
      register_privacy_modal_title: 'Política de Privacidad Internacional',
      register_privacy_modal_open_new: 'Abrir en nueva pestaña',
      register_privacy_modal_accept: 'He leído y acepto la Política',
    ...
    en: {
      ...
      register_open_privacy: 'Open Privacy Policy',
      register_accept_privacy_prefix: 'I have read and accept the ',
      register_privacy_policy: 'Privacy Policy',
      register_privacy_status: '⚠️ You must open the Privacy Policy to register.',
      register_privacy_modal_title: 'International Privacy Policy',
      register_privacy_modal_open_new: 'Open in new tab',
      register_privacy_modal_accept: 'I have read and accept the Policy',
